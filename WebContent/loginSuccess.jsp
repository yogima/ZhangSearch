	...
	<h1 class="title-agile text-center">Border Sign in form</h1>
    	<div class="content-w3ls">
        	<div class="content-bottom">
				<h2>Login Success<i class="fa fa-hand-o-down" aria-hidden="true"></i></h2>
			<form action="login" method="post">				
            	<h2><a href="homePageUser.jsp" class="text-right" style="font-color:#ffffff;">Return Homepage</a></h2>
			</form>
			</div>
    	</div>
</body>
