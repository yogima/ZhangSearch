...
<body>
	...
	<center>
		<h2 class="title-agile text-center" style="margin-top:25px;">收藏成功</h2>
		<!-- 显示题目 -->
		<h2 style="font-size:20px;margin-top:40px;">错题1</h2>
		<textarea rows="10" name="result" style="width:660px;height:100px;font-size:18px;margin-top:10px" readonly="readonly">${question.get(0)}</textarea><br>
		<!-- 显示答案 -->
		<h2 style="font-size:20px;">答案</h2>
		<textarea rows="10" name="result" style="width:660px;height:100px;font-size:18px;margin-top:5px;" readonly="readonly">${answer.get(0)}</textarea><br>
