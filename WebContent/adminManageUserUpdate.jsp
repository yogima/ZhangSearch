		...
		<div class="content-bottom">
			<div class="field-group">
				<div class="wthree-field">
					...
					<h2 class="title-agile text-center" style="margin-top:25px;">请输入您的新信息</h2>
					<h2 class="title-agile text-center" style="font-size:20px;">用&nbsp;户&nbsp;名：<input type="text" name="username" style="width:220px;height:35px;font-size:20px;margin-top:15px;color:#000000" readonly="readonly"></h2><br>
                	<h2 class="title-agile text-center" style="font-size:20px;">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="password" name="password" style="width:220px;height:35px;font-size:20px;margin-top:15px;color:#000000"></h2><br>
                	<h2 class="title-agile text-center" style="font-size:20px;">确认密码：<input type="password" name="password" style="width:220px;height:35px;font-size:20px;margin-top:15px;color:#000000"></h2><br>			
					<input type="submit" value="确认" id="submit" class="buttom" style="margin-top:20px;">
				</div>
			</div>
		</div>
	</div>
