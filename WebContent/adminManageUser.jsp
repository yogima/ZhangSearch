		...
		<div class="content-bottom">
			<div class="field-group">
				<div class="wthree-field">
					...
					<h2 class="title-agile text-center" style="margin-top:25px;">以下是您的信息</h2>
					<h2 class="title-agile text-center" style="font-size:20px;">用户名：<input type="text" name="username" style="width:250px;height:35px;font-size:20px;margin-top:15px;color:#000000" readonly="readonly"></h2><br>
					<h2 class="title-agile text-center" style="font-size:20px;">密&nbsp;&nbsp;&nbsp;码：<input type="text" name="password" style="width:250px;height:35px;font-size:20px;margin-top:15px;color:#000000"  readonly="readonly"></h2><br>
