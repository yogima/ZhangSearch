...
<body>
	...
	<center>
		...
		<h2 class="title-agile text-center" style="font-size:20px;">用户名：<input type="text" name="username" style="width:300px;height:35px;font-size:20px;margin-top:15px;color:#000000"></h2><br>
		<h2 class="title-agile text-center" style="font-size:20px;">密    码：<input type="text" name="password" style="width:300px;height:35px;font-size:20px;margin-top:15px;color:#000000"></h2><br>
